...
const AppContextProvider = ({ children }) => {
  ...
  const [layoutStyle, setLayoutStyle] = useState('full-width');
  const [showFooter, setFooterStatus] = useState(false);
  ...
  const updateThemeType = type => {
    ...
    if (type === 'semi-dark') {
      ...
      updateTheme({
        ...theme,
        palette: { ...theme.palette, ...lightTheme.palette },
        overrides: { ...theme.overrides, ...lightTheme.overrides },
      });
    }
  };
  ...
  const updateThemeColors = option => {
    ...
    updateTheme({
      ...
      palette: {
        ...theme.palette,
        primary: {
          // ...theme.palette.primary, // reason is not changes on hover color
          main: option.primary,
        },
        secondary: {
          // ...theme.palette.secondary, // reason is not changes on hover color
